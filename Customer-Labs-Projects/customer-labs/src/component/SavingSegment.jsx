...
const SavingSegment = ({ onUpdated }) => {
  ...
  const sendSegement = async () => {
    ...
    await axios.post("http://localhost:8080/segments", payload)
    setDropdownData([]);
    setSegmentName("");
    ...
    <div>
      <div className="offcanvas offcanvas-end" tabIndex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div className="offcanvas-body">
          ...
          <input className="inputName" type="text" placeholder='Name of the Segment' value={segmentName} onChange={(e) => { setSegmentName(e.target.value) }} />
        ...
        <div className="footer">
          <span>
            ...
            <button onClick={() => { onCloseRemoveData }} className='custom-btn btn-1' type="button" data-bs-dismiss="offcanvas" aria-label="Close">Cancel</button>
          </span>
        </div>
      </div>
    </div>
